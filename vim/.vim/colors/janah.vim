...
highlight NonText guifg=#ff00af ctermfg=240 ctermbg=NONE gui=bold cterm=bold
...
highlight Todo guifg=#ffdfaf ctermfg=240 ctermbg=223 gui=NONE cterm=NONE
...
" Markdown
highlight markdownBold guifg=#ffaf87 ctermfg=216 ctermbg=NONE gui=bold cterm=bold
highlight markdownItalic guifg=#87dfaf ctermfg=115 ctermbg=NONE gui=italic cterm=italic
